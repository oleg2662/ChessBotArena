    ...
    public class PositionTests
    {
        ...
        public static IEnumerable<object[]> PositionEqualityOperatorTestdata =>
            new List<object[]>
            {
                    ...
                    new object[] { new Position("A1"), new Position('A', 1), true },
                    new object[] { new Position("B1"), new Position('B', 5), false },
                    new object[] { new Position("H8"), new Position('H', 8), true },
                    new object[] { new Position("F4"), new Position('E', 5), false },
