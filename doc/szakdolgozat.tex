...
%	\centering
%	\includegraphics[width=0.8\textwidth]{img/server_dev_run_1.png}
%	\caption{Service startup projektként beállítása.}
%	\label{fig:server_dev_run_1}
%\end{figure}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item Játékkliens (Windows app)
				\item Botkliens (MI bot alkalmazás mely különböző algoritmusokat tud használni.)
			\end{itemize}
		\end{itemize}
	\end{itemize}
\end{itemize}
