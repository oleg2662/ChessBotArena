...
\usepackage[pdftex,
	...
	pdfkeywords={sakk, bot, verseny, programozás, mi, mesterséges intelligencia, szakdolgozat, alfa-béta, minimax, REST, API, chess, AI, alpha-beta, algorithm, thesis, ELTE},
...
\begin{longtable}[c]{|c|p{14cm}|}
	...
	\label{userStories:client:topScores}\\
\end{longtable}
